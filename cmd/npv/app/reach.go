...
func init() {
	...
	reachCmd.Flags().BoolVar(&reachOptions.fromCIDR.privateCIDRs, "from-private-cidrs", false, "use private CIDRs as source")
	reachCmd.Flags().BoolVar(&reachOptions.fromCIDR.publicCIDRs, "from-public-cidrs", false, "use public CIDRs as source")
	...
	reachCmd.Flags().BoolVar(&reachOptions.toCIDR.privateCIDRs, "to-private-cidrs", false, "use private CIDRs as destination")
	reachCmd.Flags().BoolVar(&reachOptions.toCIDR.publicCIDRs, "to-public-cidrs", false, "use public CIDRs as destination")
